from src.views import index, create_news, get_all_news, get_one_news, update_news, delete_news
...
def setup_routes(app):
    ...
    app.router.add_get('/get/{news_id}', get_one_news, name='get_one_news')
